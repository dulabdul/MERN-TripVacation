...
seeder.connect('mongodb://localhost:27017/db_tripvacation', function () {
    ...
    seeder.clearModels(['Category', 'Bank', 'Item', 'Member', 'Item', 'Featured', 'Image', 'Booking', 'Users'], function () {
